    ...
    <section className="formula" id="formula">
      ...
      <div className="formula-right reveal" style={{ transitionDelay: "0.2s" }}>
        ...
        <div className="formula-items">
          <div className="formula-item"><div className="fi-num">01</div><div className="fi-info"><div className="fi-title">CAFEÍNA ANHIDRA</div><div className="fi-desc">Forma purificada de cafeína con absorción máxima y efecto preciso.</div></div><div className="fi-badge">Potencia natural</div></div>
